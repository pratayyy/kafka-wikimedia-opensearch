package com.kwo.wikimedia.connect;

import com.kwo.wikimedia.connect.task.WikimediaTask;
...
public class WikimediaConnector extends SourceConnector {
    ...
    private static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(RECONNECT_TIME_CONFIG, ConfigDef.Type.LONG, null, ConfigDef.Importance.LOW, "reconnect duration (milliseconds) config for event stream url. defaults to 3 seconds");
